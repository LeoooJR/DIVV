...
class Programm:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(prog="VCFDelta", 
        ...
        self.parser.add_argument('--skip_perl_error_pvalue', 
                                 action="store_true",  
                                 required=False,
                                 help='Skip pvalue comparison if perl script return an error score (-1). Set to 1 to activate.')
        self.parser.add_argument('--specific_threshold_pvalue', 
                                 type=float, 
                                 default=0.0, 
                                 metavar='', 
                                 required=False,
        ...
        self.parser.add_argument("--exclude_indels",
                                 dest="exclude_indels",   
                                 action="store_true",      
